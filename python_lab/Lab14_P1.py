...
root = tk.Tk()
root.title("Simple GUI Applicatio") # title 
...
# Create a Button
button = tk.Button(master=root, text="Click me", command=display_text) # label and the function event for
# the button here
button.grid(row=1, column=0)
# Create a Label
label = tk.Label(root, text="")# Initiate the Label widget here
